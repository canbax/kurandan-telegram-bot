...
Rastgele bir Kur'an mealinden, rastgele bir pasaj paylaşır.
  ...
  <p>
    <a target="_blank" href="https://t.me/kurandanmesaj" class="link-primary">
      ...
      </svg> Telegram kanalına</a> katılabilirsiniz. Her gün sadece 1 mesaj atar.
  </p>
  <p>
    <a target="_blank" href="https://t.me/kurandan_bot" class="link-primary"> <svg xmlns="http://www.w3.org/2000/svg"
        width="16" height="16" fill="currentColor" class="bi bi-robot" viewBox="0 0 16 16">
        <path
      ...
      </svg> Telegram botunu </a> rastgele pasajlar almak için kullanabilirsiniz.
  </p>

  <h2> Hakkında </h2>
  <p>
    Açık kaynak kodlu, ücretsiz, reklamsızdır.
  </p>
